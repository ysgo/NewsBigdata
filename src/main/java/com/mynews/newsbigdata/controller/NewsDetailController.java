...
public class NewsDetailController {
	...
	// NewsDetail 검색 시작
	@ResponseBody
	@RequestMapping(value = "/main/NewsdetailView", method = RequestMethod.GET, produces = "application/json; charset=utf-8")
	public HashMap<String, Object> select1(Model model, News newsinfo, int curPage) {

		HashMap<String, Object> map = new HashMap<>();

		System.out.println(
				"뉴스 디테일 keyword 값:" + newsinfo.getKeyword() + " 페이지넘버" + newsinfo.getPageNo() + " 언론사네임" + newsinfo.getName());
		...
		if (newsinfo.getAction().equals("search")) {
			...
			System.out.println("언론사검색ㅇ" + newsinfo.getName() + "ㅇㅇㅇ");
			...
			if (newsinfo.getKeyword() == "") {
				...
				System.out.println("전체 페이징 값: " + pagination);
				return map;
			...
			// 2 - 키워드검색 및 필터링
				...
				System.out.println("키워드검색 들어오면서 newsname 출력 :" + newsinfo.getName());
