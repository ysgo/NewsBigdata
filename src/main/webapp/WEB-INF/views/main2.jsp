    ...
    -->
      <div class="sidebar-wrapper">
        <div class="logo">
          ...
          <a href="javascript:void(0)" class="simple-text logo-normal">Pronews 4</a>
        </div>
        <ul class="nav">
          <li class="active ">
    ...
    <div class="main-panel">
              ...
              <div class="card-header ">
                <div class="row">
                  <div class="col-sm-6 text-left">
                    ...
                    <h2 class="card-title">News-Map</h2>
                  </div>
                  <div class="col-sm-6">
                    <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                      ...
                      <label class="btn btn-sm btn-primary btn-simple" id="1">
                        ...
                        <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">정치</span>
                        <span class="d-block d-sm-none">
                      ...
                      <label class="btn btn-sm btn-primary btn-simple" id="2">
                        ...
                        <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">경제</span>
                        <span class="d-block d-sm-none">
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright"><!-- © --> &copy; NewsOnMap 
            <script>document.write(new Date().getFullYear())</script> made with by
            <a href="javascript:void(0)" target="_blank">PRONEWS 4</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
